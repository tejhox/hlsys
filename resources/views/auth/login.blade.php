<x-app-layout>
    <div class="mt-20 sm:mt-24">
        <x-guest-layout>
            {{-- <div class="w-full">
                <img src="{{ asset('images/hl-sys-logo-2.png') }}" alt="Logo" class="w-32 h-16">
            </div> --}}
            <!-- Session Status -->
            <x-auth-session-status class="mb-4 text-center" :status="session('status')" />

            <div class="card bg-base-100 shadow-xl rounded-lg overflow-hidden">
                <div class="bg-gradient-to-r from-blue-400 to-blue-700 shadow shadow-slate-400 text-white py-2 px-4">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <svg class="h-4 w-4 opacity-50" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="password" class="block mt-1 w-full ps-9" type="password"
