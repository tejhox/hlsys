<x-app-layout>
    <div>
        <div class="sm:flex ">
            <div class="hidden sm:block sm:w-1/4 lg:w-1/5 min-h-screen bg-white">
            ...
            <div x-data="{
                ...
                class="sm:w-3/4 lg:w-4/5 mt-1 sm:mt-0 flex flex-col">
                <div class="shadow py-1 px-2 flex-1 flex flex-col">
